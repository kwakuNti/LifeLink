...
-- Insert test user for donor and recipient
INSERT INTO users (id, name, email, password, role, is_verified)
VALUES
  (1, 'Test Donor', 'donor@example.com', 'hashed_password', 'donor', 1),
  (2, 'Test Recipient', 'recipient@example.com', 'hashed_password', 'recipient', 1)
ON DUPLICATE KEY UPDATE email = email;

-- Insert test donor
INSERT INTO donors (id, user_id, blood_type, init_age, bmi_tcr, dayswait_alloc, kidney_cluster, dgn_tcr, wgt_kg_tcr, hgt_cm_tcr, gfr, on_dialysis, organ_type)
VALUES (
  1, 1, 'O', 30, 22.5, 100, 2, 1.0, 65.0, 170.0, 90.0, 1, 'Kidney'
)
ON DUPLICATE KEY UPDATE user_id = user_id;

-- Insert test recipient
INSERT INTO recipients (id, user_id, patient_code, blood_type, init_age, bmi_tcr, dayswait_alloc, dgn_tcr, wgt_kg_tcr, hgt_cm_tcr, gfr, on_dialysis, organ_type)
VALUES (
